...
- [x] 2.1 Implement configuration persistence for service account JSON and target folder ID
...
- [x] 3.1 Build a settings form for service account JSON and target folder ID
...
- [ ] 4.3 Perform a manual end-to-end verification of settings save, connection test, and upload flow
